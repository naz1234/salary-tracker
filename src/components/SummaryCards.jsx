...
function Card({ icon: Icon, label, value, tone = "emerald", sub, to }) {
  ...
  const cardClassName = `group relative min-h-[102px] overflow-hidden rounded-[1.2rem] border border-white/80 dark:border-slate-700/80 bg-white/85 dark:bg-slate-900/85 p-3 shadow-[0_10px_28px_rgba(15,23,42,0.07)] backdrop-blur transition ${
    to
  ...
  const content = (
    <>
      ...
      <div className="pointer-events-none absolute -bottom-7 left-10 right-[-20%] h-14 rounded-[100%] border-t border-white/70 dark:border-slate-700/70 opacity-80" />
